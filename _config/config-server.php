...
define('CONFIG_DB_NAME', 'dozencre_themobiusation');
define('CONFIG_DB_USER', 'dozencre_admin');
define('CONFIG_DB_PASS', '!YXWx8G?');

//Website Configuration
define('CONFIG_SITE_PROTOCOL',		(!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' || $_SERVER['SERVER_PORT'] == 443) ? 'https://' : 'http://');
define('CONFIG_SITE_ROOT', 			CONFIG_SITE_PROTOCOL.'themobiusation.com/');
...
define('CONFIG_CLASS_PATH', 		'/_include/');
define('CONFIG_JS_PATH', 			'/_js/');
define('CONFIG_TOOLKIT_PATH', 		'/_toolkit/');
define('CONFIG_THUMB_ENGINE', 		'gd');
define('CONFIG_EDITOR_TOOLBAR', 	'Full'); //Full
define('CONFIG_EDITOR_IMAGE_UPLOAD_FOLDER', '/_upload/editor/image/');
define('CONFIG_EDITOR_FILE_UPLOAD_FOLDER',  '/_upload/editor/file/');
...
$language_enabled = array('zh'=>'中文', 'en'=>'English'); 

//Panel language settings
$available_language = array('zh-tw'=>'中文','en-us'=>'English'); 
...
$multi_lang_url = array(
	'zh-tw' => CONFIG_SITE_PROTOCOL.'themobiusation.com/zh/',
	'en-us' => CONFIG_SITE_PROTOCOL.'themobiusation.com/'
);
